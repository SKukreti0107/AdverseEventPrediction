        ...
        for sentence in sentences:
            if sentence.strip():
                ...
                for entity in entities:
                    ...
                    # Enhanced negation patterns with better context handling
                    negation_patterns = [
                        ...
                        r'hasn\'t\s+' + re.escape(entity_text),
                        r'haven\'t\s+' + re.escape(entity_text),
                        r'absence\s+of\s+' + re.escape(entity_text),
                        r'ruled\s+out\s+' + re.escape(entity_text),
                        r'no\s+evidence\s+of\s+' + re.escape(entity_text)
                    ]
